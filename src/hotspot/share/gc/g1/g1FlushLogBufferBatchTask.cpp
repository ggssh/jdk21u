 ...
 */
 ...
 class G1FlushLogBufferBatchTask::JavaThreadFlushLogs : public G1AbstractSubTask {
   ...
   struct FlushLogsClosure : public ThreadClosure {
     ...
     FlushLogsClosure() : _tlab_stats(), _refinement_stats() { }
...
//  G1GCPhaseTimes::FlushLogsBeforeDataStructure
 ...
 class G1FlushLogBufferBatchTask::NonJavaThreadFlushLogs : public G1AbstractSubTask {
   struct FlushLogsClosure : public ThreadClosure {
     G1ConcurrentRefineStats _refinement_stats;
